...
static int glad_gl_find_extensions_gl( int version) {
    ...
    GLAD_GL_EXT_mesh_shader = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_mesh_shader");
    ...
    GLAD_GL_MESA_map_buffer_client_pointer = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_MESA_map_buffer_client_pointer");
